...
devil_may_cry_3_location = {}
devil_may_cry_3_location.__index = devil_may_cry_3_location
...
function devil_may_cry_3_location.new(name)
	local self = setmetatable({}, devil_may_cry_3_location)
	if name then
...
function devil_may_cry_3_location:connect_one_way(exit, rule)
	if type(exit) == "string" then
		...
		if existing then
			...
			exit = devil_may_cry_3_location.new(exit)
		end
	end
	if rule == nil then
		rule = always
...
function devil_may_cry_3_location:connect_two_ways(exit, rule)
...
function devil_may_cry_3_location:connect_one_way_entrance(name, exit, rule)
	if rule == nil then
		rule = always
	end
	self.exits[#self.exits + 1] = { exit, rule }
...
function devil_may_cry_3_location:connect_two_ways_entrance(name, exit, rule)
...
-- acts as a shortcut for 2 connect_one_way_entrance-calls
function devil_may_cry_3_location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
function devil_may_cry_3_location:connect_two_ways_stuck(exit, rule1, rule2)
...
function devil_may_cry_3_location:accessibility()
...
--
function devil_may_cry_3_location:discover(accessibility, keys)
...
entry_point = devil_may_cry_3_location.new("entry_point")
